...
help:
	...
	@echo "  make build              - Build all Docker images (runs go mod tidy)"
	@echo "  make up                 - Start CVT server and producer"
	@echo "  make down               - Stop all services"
	@echo "  make logs               - View logs from all services"
	@echo "  make clean              - Remove containers and images"
	@echo "  make producer-up        - Start just the producer"
	@echo "  make producer-down      - Stop just the producer"
	@echo "  make producer-deps      - Update producer Go dependencies"
	@echo ""
	@echo "Testing (All):"
	@echo "  make test               - Run all tests (unit + integration)"
	@echo "  make test-unit          - Run all unit/mock tests (no producer needed)"
	@echo "  make test-live          - Run all integration tests (requires producer)"
	@echo ""
	@echo "Producer Contract Tests:"
	@echo "  make test-producer              - Run all producer contract tests"
	@echo "  make test-producer-compliance   - Schema compliance tests"
	@echo "  make test-producer-middleware   - Middleware mode tests"
	...
	@echo ""
	@echo "Consumer-1 Contract Tests (Node.js):"
	@echo "  make test-consumer-1              - Run all Consumer-1 tests"
	@echo "  make test-consumer-1-mock         - Mock tests (no producer needed)"
	@echo "  make test-consumer-1-live         - Live tests (requires producer)"
	@echo "  make test-consumer-1-registration - Registration tests"
	@echo ""
	@echo "Consumer-2 Contract Tests (Python):"
	@echo "  make test-consumer-2              - Run all Consumer-2 tests"
	@echo "  make test-consumer-2-mock         - Mock tests (no producer needed)"
	@echo "  make test-consumer-2-live         - Live tests (requires producer)"
	@echo "  make test-consumer-2-registration - Registration tests"
	@echo ""
	@echo "Consumer CLI Operations:"
	@echo "  make consumer-1-add             - Consumer-1: add (default: 5 + 3)"
	@echo "  make consumer-1-subtract        - Consumer-1: subtract (default: 5 - 3)"
	@echo "  make consumer-1-add-validate    - Consumer-1: add with CVT validation"
	@echo "  make consumer-1-subtract-validate - Consumer-1: subtract with CVT validation"
	@echo "  make consumer-2-add             - Consumer-2: add (default: 5 + 3)"
	@echo "  make consumer-2-multiply        - Consumer-2: multiply (default: 5 * 3)"
	@echo "  make consumer-2-divide          - Consumer-2: divide (default: 5 / 3)"
	@echo "  make consumer-2-add-validate    - Consumer-2: add with CVT validation"
	@echo "  make consumer-2-multiply-validate - Consumer-2: multiply with CVT validation"
	@echo "  make consumer-2-divide-validate - Consumer-2: divide with CVT validation"
	@echo "  Custom values: make <target> x=<num> y=<num>"
	@echo ""
	@echo "Batch Operations:"
	@echo "  make test-all           - Run all consumer CLI operations"
	@echo "  make test-contracts     - Run all consumer CLI operations with CVT validation"
	@echo ""
	@echo "Demo:"
